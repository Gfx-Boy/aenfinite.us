...
export const metadata: Metadata = {
  title: "Conception Web & Marketing Digital Blog | Expert Tips & Insights | Aenfinite®",
  ...
  openGraph: {"title":"Conception Web & Marketing Digital Blog | Expert Tips & Insights | Aenfinite®","description":"Expert insights on web design, logo design, digital marketing, and branding. Get the latest tips, trends, and strategies to grow your business online.","url":"https://aenfinite.us/fr/blog/","siteName":"Aenfinite","type":"website","images":[{"url":"https://aenfinite.us/fr/blog/"}]},
  twitter: {"card":"summary_large_image","title":"Conception Web & Marketing Digital Blog | Aenfinite®","description":"Expert insights on web design, logo design, digital marketing, and branding.","images":["https://aenfinite.us/wp-content/uploads/2024/11/share-image-dd.jpg"]},
...
const pageContent = `<script>
    ...
    <div class="blog-header">
        <h1>Conception Web & Marketing Digital Insights</h1>
    ...
    <div class="blog-posts">
        ...
        <article class="blog-post">
            <h2><a href="/blog/10-web-design-trends-2025/">10 Conception Web Trends That Will Dominate 2025</a></h2>
            <div class="meta">Published: January 15, 2025 | Category: Conception Web</div>
            <p>Discover the latest web design trends that will shape user experience and drive conversions in 2025...</p>
            <a href="/blog/10-web-design-trends-2025/">Lire la Suite →</a>
        </article>
        
        <article class="blog-post">
            <h2><a href="/blog/logo-design-psychology/">The Psychology Behind Effective Création de Logo</a></h2>
            <div class="meta">Published: January 10, 2025 | Category: Création de Logo</div>
            <p>Learn how color, shape, and typography in logo design influence customer perception and brand success...</p>
            <a href="/blog/logo-design-psychology/">Lire la Suite →</a>
        </article>
        ...
        <article class="blog-post">
            ...
            <a href="/blog/seo-strategies-2025/">Lire la Suite →</a>
        </article>
    </div>
`;
...
export default function Page() {
  return (
    <>
        ...
        "url":"https://aenfinite.us/fr/blog/",
        "publisher": {
            "@type": "Organization",
            "name": "Aenfinite®",
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Conception Web & Marketing Digital Blog",
