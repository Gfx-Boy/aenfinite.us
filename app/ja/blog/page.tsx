...
export const metadata: Metadata = {
  title: "Webデザイン & デジタルマーケティング ブログ | Expert Tips & Insights | Aenfinite®",
  ...
  openGraph: {"title":"Webデザイン & デジタルマーケティング ブログ | Expert Tips & Insights | Aenfinite®","description":"Expert insights on web design, logo design, digital marketing, and branding. Get the latest tips, trends, and strategies to grow your business online.","url":"https://aenfinite.us/ja/blog/","siteName":"Aenfinite","type":"website","images":[{"url":"https://aenfinite.us/ja/blog/"}]},
  twitter: {"card":"summary_large_image","title":"Webデザイン & デジタルマーケティング ブログ | Aenfinite®","description":"Expert insights on web design, logo design, digital marketing, and branding.","images":["https://aenfinite.us/wp-content/uploads/2024/11/share-image-dd.jpg"]},
...
const pageContent = `<script>
    ...
    <div class="blog-header">
        <h1>Webデザイン & デジタルマーケティング Insights</h1>
        <p>Expert tips, trends, and strategies to grow your business online</p>
    </div>
    
    <div class="blog-posts">
        <!-- ブログ posts would be dynamically loaded here -->
        <article class="blog-post">
            <h2><a href="/blog/10-web-design-trends-2025/">10 Webデザイン Trends That Will Dominate 2025</a></h2>
            <div class="meta">Published: January 15, 2025 | Category: Webデザイン</div>
            <p>Discover the latest web design trends that will shape user experience and drive conversions in 2025...</p>
            <a href="/blog/10-web-design-trends-2025/">続きを読む →</a>
        </article>
        
        <article class="blog-post">
            <h2><a href="/blog/logo-design-psychology/">The Psychology Behind Effective ロゴデザイン</a></h2>
            <div class="meta">Published: January 10, 2025 | Category: ロゴデザイン</div>
            <p>Learn how color, shape, and typography in logo design influence customer perception and brand success...</p>
            <a href="/blog/logo-design-psychology/">続きを読む →</a>
        </article>
        ...
        <article class="blog-post">
            ...
            <a href="/blog/seo-strategies-2025/">続きを読む →</a>
        </article>
    </div>
`;
...
export default function Page() {
  return (
    <>
        ...
        "url":"https://aenfinite.us/ja/blog/",
        "publisher": {
            "@type": "Organization",
            "name": "Aenfinite®",
